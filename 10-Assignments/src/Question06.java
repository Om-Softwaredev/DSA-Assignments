 ...
 * Note: The discs are arranged such that the top disc is numbered 1 
 * and the bottom-most disc is numbered N. Also, all the discs have different sizes
...
public class Question06 {
	 ...
	 public static int towerOfHanoi(int N, int fromRod, int toRod, int auxRod) {
	        if (N == 1) {
	    ...
	    public static void main(String[] args) {
	        int N = 2;
	        System.out.println("Total moves: " + towerOfHanoi(N, 1, 3, 2));
	    }
